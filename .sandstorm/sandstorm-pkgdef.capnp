...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "z6xw47tzv19jznw5k7305hdxvg11rf560v35s5dz1spdx989ykph",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "SpaceTalk"),
    ...
    actions = [
      ...
      ( title = (defaultText = "New Chat Service"),
        command = .myCommand
  ...
  sourceMap = (
    ...
    searchPath = [
      ( sourcePath = "/opt/app/.sandstorm/bundle" ),
